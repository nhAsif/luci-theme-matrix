...
<p align="center">
    <img src="https://raw.githubusercontent.com/eamonxg/assets/master/matrix/logo/logo-lockup.png" width="360" alt="Matrix Theme"/>
</p>
...
<div align="center">
  ...
  <a href="https://github.com/eamonxg/luci-theme-matrix/releases/latest"><img alt="GitHub release" src="https://img.shields.io/github/v/release/eamonxg/luci-theme-matrix"></a>
  <a href="https://github.com/eamonxg/luci-theme-matrix/releases"><img alt="Downloads" src="https://img.shields.io/github/downloads/eamonxg/luci-theme-matrix/total"></a>
  ...
  <a href="#加入贡献"><img alt="Contributors" src="https://img.shields.io/github/contributors/eamonxg/luci-theme-matrix?color=orange"></a>
</div>

<div align="center">
  <img src="https://raw.githubusercontent.com/eamonxg/assets/master/matrix/preview/theme/multi-device-showcase.png" alt="Multi-Device Showcase" width="100%">
</div>
...
- **高度可定制**：[luci-app-matrix-config](https://github.com/eamonxg/luci-app-matrix-config) 插件内置多套主题预设，可自由切换；同时还支持自定义浅色/深色色彩令牌、导航布局（Mega Menu、下拉菜单、侧边栏）、布局间距、字体排版、品牌标识（Logo、favicon、登录背景），以及添加或编辑悬浮工具栏中的常用页面。

## 预览

<div align="center">
  <img src="https://raw.githubusercontent.com/eamonxg/assets/master/matrix/preview/theme/preview-demo.gif" alt="Theme Demo" width="100%">
  <br>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/eamonxg/assets/master/matrix/preview/theme/dark-light-preview.png" alt="Dark and Light Preview" width="49%">
  <img src="https://raw.githubusercontent.com/eamonxg/assets/master/matrix/preview/theme/mobile-preview.png" alt="Mobile Preview" width="49%">
</div>
...
- **opkg** (OpenWrt < 25.12):
  ...
  ```sh
  cd /tmp && uclient-fetch -O luci-theme-matrix.ipk https://github.com/eamonxg/luci-theme-matrix/releases/latest/download/luci-theme-matrix_1.0.0-r20260619_all.ipk && opkg install luci-theme-matrix.ipk
  ```

- **apk** (OpenWrt 25.12+ 及 snapshots):

  ```sh
  cd /tmp && uclient-fetch -O luci-theme-matrix.apk https://github.com/eamonxg/luci-theme-matrix/releases/latest/download/luci-theme-matrix-1.0.0-r20260619.apk && apk add --allow-untrusted luci-theme-matrix.apk
  ```

## 从源码构建

使用 OpenWrt 构建系统自行编译。主机前置条件见 [Build system setup](https://openwrt.org/docs/guide-developer/toolchain/install-buildsystem)。产物位于 `bin/packages/<arch>/base/`（例如 `bin/packages/x86_64/base/luci-theme-matrix_*_all.ipk`），拷贝到路由器后按上文方式安装即可。
...
git clone https://github.com/eamonxg/luci-theme-matrix.git package/luci-theme-matrix
./scripts/feeds update -a
./scripts/feeds install -a

# 在 menuconfig 中勾选主题：LuCI → Themes → luci-theme-matrix
make menuconfig
...
Matrix 使用 **Vite** 与现代前端工具链构建，并尝试将 AI 融入开发全链路。详见[开发文档](.dev/docs/DEVELOPMENT.md)。欢迎提交建议或 PR。
