...
// /luci-static/matrix/patches/<page>.css in dev. Without this, header.ut's patch
...
function patchCssRoutes(): Record<string, string> {
  ...
  return Object.fromEntries(
    readdirSync(dir)
      ...
      .map((f) => [`/luci-static/matrix/patches/${f}`, `/src/media/patches/${f}`]),
  );
}
...
function createLocalServePlugin(): Plugin {
  const resourceConfig: ResourceConfig = {
    css: {
      routes: {
        "/luci-static/matrix/main.css": "/src/media/main.css",
        "/luci-static/matrix/login.css": "/src/media/login.css",
        ...patchCssRoutes(),
      },
      shouldRewrite: true,
    ...
    js: {
      routes: {
        "/luci-static/resources/view/matrix/sysauth.js":
          "src/resource/view/matrix/sysauth.js",
        "/luci-static/resources/menu-matrix.js": "src/resource/menu-matrix.js",
      },
      shouldRewrite: false,
...
const UT_TEMPLATE_DIR = resolve(PROJECT_ROOT, "ucode/template/themes/matrix");
const UT_REMOTE_DIR = "/usr/share/ucode/luci/template/themes/matrix";
    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          // matrix/patches/<page>.css (the `patches/` key prefix lands them there
        ...
        output: {
          assetFileNames: "matrix/[name].[ext]",
        },
      },
    },
