...
First stable release of Matrix, centered on a navigation overhaul.
...
- For remaining changes, see the [full changelog](https://github.com/eamonxg/luci-theme-matrix/compare/v0.12.0...v1.0.0)
