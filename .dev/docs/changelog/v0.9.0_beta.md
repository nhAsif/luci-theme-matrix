...
- Added support for [luci-app-matrix-config](https://github.com/eamonxg/luci-app-matrix-config) to customize the theme.
...
- see the [full changelog](https://github.com/eamonxg/luci-theme-matrix/compare/v0.8.0_beta...v0.9.0_beta)
